...
Both central strands of thought in Oxford epistemology and philosophy of language are intertwined in, and form the basis, of Austin's \citeyearpar{Austin:1962lr}, at times, exasperated, criticism of Ayer. There are four main critical themes (see Martin, \citeyear[for discussion]{Martin:2000nx}):
\begin{enumerate}
    \item The dichotomy between sense data and material objects is rejected as misconceived.
    ...
    \item Our ordinary talk of perception is claimed to be in good order and to be bale to make finer distinctions than the technical vocabulary that Ayer commends as a replacement.
...
\end{enumerate}
We shall only be concerned with the fourth.
